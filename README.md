...
| 🛰️ **Sentinel-66** { Disaster Response Mesh Network } | Real-time disaster response mesh network simulation. Survivors broadcast their location from a mobile PWA; mission control operators monitor a live "God View" map — tracking survivor nodes, hazards, and safe hub routes. All state synced in real time via a WebSocket relay server. *Oklahoma Innovation Challenge* | Next.js, Tauri, Zustand, Rust, Socket.IO, Turborepo, Node.js | [Repo](https://github.com/lucm23) |
